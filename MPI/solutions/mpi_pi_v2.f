...
c       Initialize variables
        ...
        integer :: niter_perrank, imin_loop, imax_loop
...
c       Divide iterations
        niter_perrank = niter / worldsize;
        imin_loop = myRank*niter_perrank;
        imax_loop = (myRank+1)*niter_perrank - 1;
        print *,"Rank ",myRank,": calculates elements ",
     &          imin_loop," through ", imax_loop
